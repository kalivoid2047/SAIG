...
- **Scope:** this ADR covers yield + demand. Risk intelligence (six-domain scoring) and OR-Tools route optimization are the remaining Phase 3 modules and reuse this same registry/lineage backbone.
